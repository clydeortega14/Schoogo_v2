...
<div class="container">
	...
	{{-- <form action="{{ route('') }}" method="POST"> --}}
		...
		<div class="row">
			<div class="col-md-12">
				<p class="text-white"> <strong class="text-warning">WARNING ! </strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus, numquam maiores quis! Iusto tenetur, expedita explicabo dolorem fugit ad, inventore voluptas at architecto minus corporis dignissimos nisi tempore doloribus laudantium.</p>
			</div>
		</div>
		<div class="row justify-content-end">
			<div class="col-md-6">
				<div class="float-right">
					<p class="text-white">  <input type="checkbox"> I agree to terms and conditions </p>
				</div>
			</div>
		</div>
		<br>
